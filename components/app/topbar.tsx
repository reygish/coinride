...
type TopbarProps = {
  ...
  /**
   * Tweak: Replace these placeholders with values from your auth/profile store
   * or Supabase (e.g. profiles table).
   */
  username?: string;
  avatarUrl?: string;

  /**
   * Current balance shown in the header.
   * Tweak: Pass your real "available balance" here.
   */
  availableBalance?: number;

  /**
   * Tweak: Use your real notification count.
   * We render a small badge when this is > 0.
   */
  notificationCount?: number;
};

function formatCurrency(amount: number) {
  // Tweak: Change locale/currency to match your product.
